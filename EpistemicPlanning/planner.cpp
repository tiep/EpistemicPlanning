...
//    cout << "--------------executing drive_truck2_pos2_apt2 for kripke at 0 ------------------------" << endl;
//    int indexact = m_action_map.find("drive_truck2_pos2_apt2")->second;
//    KActionList::iterator itacl = ontic.begin();
//    itacl = itacl + indexact;
//    Kripke* prin0 = execute_ontic(m_init_cstates.at(0), *itacl);
//    prin0->print_report();
//    cout << "---------executing sense_truck2_apt2------" << endl;
//    indexact = m_action_map.find("sense_truck2_apt2")->second;
//    itacl = ontic.begin();
//    itacl = itacl + indexact;
//
//    Kripke* prin1 = execute_sensing(*prin0, *itacl);
//    prin1->print_report();
    
//    cout << "---------executing sense_airplane_apt2------" << endl;
//    indexact = m_action_map.find("sense_airplane_apt2")->second;
//    itacl = ontic.begin();
//    itacl = itacl + indexact;
    
//    Kripke* prin2 = execute_ontic(*prin1, *itacl);
//    prin2->print_report();
    //return 1;
